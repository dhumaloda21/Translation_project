...
def convert_language():
    ...
    # Insert the input word, selected language, and translated word into the MySQL database
    sql = "INSERT INTO translations (word, lang, translation) VALUES (%s, %s, %s)"
    val = (a1, convert, trans_text)
